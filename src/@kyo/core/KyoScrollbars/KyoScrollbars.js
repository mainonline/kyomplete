...
const KyoScrollbars = forwardRef((props, ref) => {
  ref = ref || createRef();
...
function mapStateToProps({ kyo }) {
  return {
    customScrollbars: kyo.settings.current.customScrollbars,
  };
}

KyoScrollbars.propTypes = {
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(
  withRouterAndRef(KyoScrollbars)
);
