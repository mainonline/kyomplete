...
import KyoPageCardedHeader from './KyoPageCardedHeader';
import KyoPageCardedSidebar from './KyoPageCardedSidebar';
...
const KyoPageCarded = forwardRef((props, ref) => {
  // console.info("render::KyoPageCarded");
  ...
  return (
    <>
      ...
      >
        {props.header && <KyoPageCardedHeader header={props.header} />}
        ...
        <div className="flex flex-auto flex-col container z-10 h-full shadow-1 rounded-t-16 relative overflow-hidden">
          <div className="FusePageCarded-wrapper">
            ...
            >
              {props.content && (
                <div className={clsx('KyoPageCarded-content')}>{props.content}</div>
              )}
            </FuseScrollbars>
...
export default memo(styled(KyoPageCarded)``);
