...
import KyoPageSimpleHeader from './KyoPageSimpleHeader';
import KyoPageSimpleSidebar from './KyoPageSimpleSidebar';
...
const KyoPageSimple = forwardRef((props, ref) => {
  // console.info("render::KyoPageSimple");
      ...
      >
        <div className="flex flex-auto flex-col z-10 h-full">
          <div className="FusePageSimple-wrapper">
            ...
            >
              {props.header && <KyoPageSimpleHeader header={props.header} />}
              {props.content && (
                <KyoScrollbars
...
export default memo(styled(KyoPageSimple)``);
